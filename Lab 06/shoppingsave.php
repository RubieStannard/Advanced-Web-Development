...
if (isset($_POST["itemname"], $_POST["quantity"])) { // check if both form data exists
    ...
    fclose($handle); // close the text file
        $newdata = !(in_array($item, $itemdata)); // check if item exists in array - in_array searches an array for a specific value
    } else {
    ...
    foreach ($alldata as $data) { // loop using for each - foreach loops through each key/value pair in an array
