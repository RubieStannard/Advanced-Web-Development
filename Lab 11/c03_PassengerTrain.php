...
if (isset($_GET['distance']) && isset($_GET['stops'])) {
	if (is_numeric($_GET['distance']) & is_numeric($_GET['stops'])) {
		...
		// else
			...
			$DurationHours = $DurationTotalMinutes / 60; // $DurationHours = $DurationTotal Minutes / 60;
...
?>
<form action="c03_PassengerTrain.php" method="GET" enctype="application/x-www-form-urlencoded"> <!-- <form action="PassengerTrain.php" method="get" enctype="application/x-www-form-urlencoded"> -->
